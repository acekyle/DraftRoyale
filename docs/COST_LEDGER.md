...
| Season-0 hero production pass | **APPROVED 2026-08-21 (D-026, Founder chat): $25 HARD ceiling.** Tripo text-to-3D (triangle GLB, ~20 cr ≈ $0.20/gen from the Founder's API top-up) for all 12 heroes incl. iterations; Meshy auto-rig for bipeds on the already-paid Pro month (credits, no new cash). Per-action log: tools/heroforge/spend-log.jsonl; reconciled here on completion. Cancel BOTH subs before renewal once the pass completes | ≤$25 | none once subs cancelled | Procedural heroes remain the shipped fallback for any fighter that fails the rubric |
